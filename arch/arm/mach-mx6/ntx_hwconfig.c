...
const char * gszKeyPadA[]={
	...
	"E606A0","FL_Key","NO_Key","FL+HOME", // 10~14 
};
/*
 *
...
const char * gszTouchCtrlA[]={"No","TSC2004","Wacom Digitizer","Watop Digitizer","AUO-TP2","neonode","PVI","ITE","neonode_v2","ektf2132"};//touch controller .
...
const char * gszFrontLightLEDrvA[]={"SY7201","A8169"};//Front Light LED driver IC .
